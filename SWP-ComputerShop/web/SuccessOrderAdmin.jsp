...
<html lang="en">
    ...
    <head>
        <title>Danh sách đơn hàng đã giao| Quản trị Admin</title>
        <meta charset="utf-8">
    ...
    <c:if test="${errorRole != null}">
        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item active"><a href="ordermanager?order=3"><b>Danh sách đơn hàng đã giao</b></a></li>
                </ul>
                <div id="clock"></div>
            </div>
            <div class="row">
                                ...
                                <table class="table table-hover table-bordered mb-2 table-responsive-lg" id="sampleTable">
                                    <thead>
                                        <tr style="background: #eee">
                                            ...
                                            <th class="text-center" style="width:35%">Địa chỉ</th>
                                            <th class="text-center" style="width:11%">Tổng tiền</th>
                                            <th class="text-center">Tình trạng</th>
                                            <th class="text-center" style="width:6%">Chức Năng</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:if test="${list != null && !empty list}">
                                            <c:forEach items="${list}" var="l">
                                                <tr>
                                                    ...
                                                    <td class="text-center"><span class="btn btn-sm light btn-success">Đã hoàn thành</span></td>
                                                    <td>
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <div class="dataTables_paginate paging_simple_numbers" id="sampleTable_paginate">
                                                <ul class="pagination1">
                                                    ...
                                                    <c:if test="${page != 1}">
                                                        <li class="paginate_button page-item previous disabled" id="sampleTable_previous">
                                                            <a href="ordermanager?page=${page-1}&key=${key}&entryperpage=${entryperpage}&num= ${num}&order=3" 
                                                    ...
                                                    <c:forEach begin="1" end="${num}" var="i">
                                                        ...
                                                        <c:if test="${i != page}">
                                                            <li class="paginate_button page-item active">
                                                                <a href="ordermanager?page=${i}&key=${key}&entryperpage=${entryperpage}&num= ${num}&order=3"
        ...
        <script>
                                                                        ...
                                                                        function submit(page, num, key) {
                                                                            ...
                                                                            window.location.href = "/SWP391_LapTop/ordermanager?entryperpage=" + entryperpage.value + "&num=" + num + "&key=" + key+ "&order=3";
                                                                            ;
                                                                        }
                                                                        jQuery(function () {
