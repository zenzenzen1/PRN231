...
<html lang="en">
    ...
    <head>
        <title>Danh sách đơn hàng đã hủy| Quản trị Admin</title>
        <meta charset="utf-8">
    ...
    <c:if test="${errorRole != null}">
        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item active"><a href="ordermanager?order=4"><b>Danh sách đơn hàng đã hủy</b></a></li>
                </ul>
                <div id="clock"></div>
            </div>
            <div class="row">
                                        ...
                                        <c:if test="${list != null && !empty list}">
                                            <c:forEach items="${list}" var="l">
                                                <tr>
                                                    ...
                                                    <td class="text-center"><span class="btn btn-sm light btn-danger">Đã hủy</span></td>
                                                    <td>
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <div class="dataTables_paginate paging_simple_numbers" id="sampleTable_paginate">
                                                <ul class="pagination1">
                                                    ...
                                                    <c:if test="${page != 1}">
                                                        <li class="paginate_button page-item previous disabled" id="sampleTable_previous">
                                                            <a href="ordermanager?page=${page-1}&key=${key}&entryperpage=${entryperpage}&num= ${num}&order=4" 
                                                    ...
                                                    <c:forEach begin="1" end="${num}" var="i">
                                                        ...
                                                        <c:if test="${i != page}">
                                                            <li class="paginate_button page-item active">
                                                                <a href="ordermanager?page=${i}&key=${key}&entryperpage=${entryperpage}&num= ${num}&order=4"
        ...
        <script>
                                                                    ...
                                                                    function submit(page, num, key) {
                                                                        ...
                                                                        window.location.href = "/SWP391_LapTop/ordermanager?entryperpage=" + entryperpage.value + "&num=" + num + "&key=" + key+ "&order=4";
                                                                        ;
                                                                    }
                                                                    jQuery(function () {
