    ...
    <c:if test="${errorRole != null}">
        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item active"><a href="adminstaff"><b>Quản lý nhân viên</b></a></li>
                </ul>
                <div id="clock"></div>
            </div>
            <div class="row">
                    ...
                    <div class="tile">
                        <div class="tile-body">
                            <div class="row element-button">
                                <div class="col-sm-2">
                                    <a class="btn btn-add btn-sm" href="addstaff?key=${key}&entryperpage=${entryperpage}" title="Thêm"><i class="fas fa-plus"></i>
                                        Thêm nhân viên</a>
                                </div>
                                <div class="col-sm-2">
                                    <a class="btn btn-cancel btn-sm" href="/SWP391_LapTop/listdeletestaff" title="Danh sách nhân viên đã xóa"><i class="fas fa-trash-alt"></i> 
                                        Danh sách nhân viên đã xóa</a>
                                </div>
                                <div class="col-sm-2">
                            ...
                            <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                    ...
                                    <div class="col-sm-12 col- col-md-6">
                                        <form id="frm" action="adminstaff"> 
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="key" class="form-control input-text" placeholder="Nhập tên hoặc mã người dùng hoặc địa chỉ hoặc email" 
                                ...
                                <form action="deletestaff" method="post">
                                    <button type="submit" id="deleteSelected" class="btn btn-primary" name="btno" value="0">Xóa đã chọn</button>
                                    <button type="submit" id="deleteSelected" class="btn btn-deleteall" name="btna" value="1">Xóa tất cả</button>
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach items="${data}" var="item">
                                                <tr>
                                                    ...
                                                    <td><button class="btn btn-primary btn-sm trash mr-1" type="button" title="Xóa"
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <div class="dataTables_paginate paging_simple_numbers" id="sampleTable_paginate">
                                                <ul class="pagination1">
                                                    ...
                                                    <c:if test="${page != 1}">
                                                        <li class="paginate_button page-item previous disabled" id="sampleTable_previous">
                                                            <a href="/SWP391_LapTop/adminstaff?page=${page-1}&key=${key}&entryperpage=${entryperpage}&num= ${num}" 
                                                    ...
                                                    <c:forEach begin="1" end="${num}" var="i">
                                                        ...
                                                        <c:if test="${i != page}">
                                                            <li class="paginate_button page-item active">
                                                                <a href="/SWP391_LapTop/adminstaff?page=${i}&key=${key}&entryperpage=${entryperpage}&num= ${num}"
        ...
        <script>
                                                                    function submit(page, num, key) {
                                                                        ...
                                                                        window.location.href = "/SWP391_LapTop/adminstaff?entryperpage=" + entryperpage.value + "&num=" + num + "&key=" + key;
                                                                    }
                                                                                ...
                                                                                buttons: ["Hủy bỏ", "Đồng ý"],
                                                                                    ...
                                                                                    .then((willDelete) => {
                                                                                        if (willDelete) {
                                                                                            ...
                                                                                            window.location.href = "/SWP391_LapTop/deletestaff?id=" + userId + "&page=" + page + "&num=" + num + "&key=" + key + "&entryperpage" + entryperpage;
                                                                                        }
                                                                                    });
                                                                        });
                                                                    });
