...
<!--                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <a class="btn btn-add btn-sm" href="/SWP391_LapTop/listUserDelete" title="Thêm"><i class="fas fa-trash-alt"></i>
                                    ...
                                    <div class="col-md-6 ml-md-0">
                                        <div id="sampleTable_filter" class="dataTables_filter">
                                            <form id="frm" action="productAdmin">
                                                <label class="entry_search">Tìm kiếm:
                                                    <input type="hidden" name="entryperpage" value="${entryperpage}">
                                                    <input name="key" type="search" class="form-control form-control-sm entry_search2"
                                                           placeholder="Nhập tên sản phẩm hoặc tên danh mục hoặc mã sản phẩm" aria-controls="sampleTable"
                                                           style="width: 25rem">
                                                </label>
                                            </form>
                                        </div>
