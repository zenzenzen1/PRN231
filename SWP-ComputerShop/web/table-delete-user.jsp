    ...
    <c:if test="${errorRole != null}">
                        ...
                        <div class="tile-body">
                            <div class="row element-button">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <a class="btn btn-add btn-sm" href="/SWP391_LapTop/userAdmin" title="Thêm"><i class="fas fa-plus"></i>
                            ...
                            <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <form id="frm" action="listUserDelete"> 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button data-page ="${page}"
                                                            ...
                                                            onclick="myFunction(this)" data-id="${item.getUserID()}"><i class="fas fa-undo"></i> 
                                                    </button>
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <div class="dataTables_paginate paging_simple_numbers" id="sampleTable_paginate">
                                                <ul class="pagination1">
                                                    ...
                                                    <c:if test="${page != 1}">
                                                        <li class="paginate_button page-item previous disabled" id="sampleTable_previous">
                                                            <a href="/SWP391_LapTop/listUserDelete?page=${page-1}&key=${key}&entryperpage=${entryperpage}&num= ${num}" 
                                                    ...
                                                    <c:forEach begin="1" end="${num}" var="i">
                                                        ...
                                                        <c:if test="${i != page}">
                                                            <li class="paginate_button page-item active">
                                                                <a href="/SWP391_LapTop/listUserDelete?page=${i}&key=${key}&entryperpage=${entryperpage}&num= ${num}"
        ...
        <script>
            function submit(page, num, key) {
                ...
                window.location.href = "/SWP391_LapTop/listUserDelete?entryperpage=" + entryperpage.value + "&num=" + num + "&key=" + key;
         ...
         <script>
                                jQuery(function () {
                                    jQuery(".undo").click(function () {
                                        ...
                                        swal({
                                            title: "Cảnh báo",
                                            text: "Bạn có chắc chắn là muốn hoàn tác người dùng này?",
                                            buttons: ["Hủy bỏ", "Đồng ý"],
                                        })
                                                .then((willUpdate) => {
                                                    if (willUpdate) {
                                                        // Chuyển hướng URL với ID sản phẩm 
                                                        window.location.href = "/SWP391_LapTop/rollbackUser?id=" + productId + "&page=" + page + "&num=" + num + "&key=" + key + "&entryperpage=" + entryperpage;
                                                    }
                                                });
                                    });
                                });
                                ...
                                $(function () {
                                    $("#rollbackSelected").click(function () {
                                        ...
                                        if (selectedProducts.length > 0) {
                                            swal({
                                                title: "Cảnh báo",
                                                text: "Bạn có chắc chắn muốn hoàn tác các người dùng đã chọn?",
                                                buttons: ["Hủy bỏ", "Đồng ý"],
                                            }).then(function (willUpdate) {
                                                if (willUpdate) {
                                                    // Chuyển hướng URL với danh sách các ID sản phẩm
                                                    window.location.href = "/SWP391_LapTop/rollbackCheckboxUser?ids=" + selectedProducts.join(",") + "&rollback=0" + "&page=" + page + "&num=" + num + "&key=" + key + "&entryperpage=" + entryperpage;
                                                }
                                            });
                                        } else {
                                            swal("Cảnh báo", "Vui lòng chọn ít nhất một người dùng để hoàn tác.", "warning");
                                        }
                                    });
                                });
                            </script>
                            <script>
                                ...
                                document.getElementById("rollbackAll").addEventListener("click", function () {
                                    ...
                                    if (size > 0) {
                                        ...
                                        swal({
                                            title: "Cảnh báo",
                                            text: "Bạn có chắc chắn muốn hoàn tác tất cả người dùng ?",
                                            buttons: ["Hủy bỏ", "Đồng ý"],
                                        }).then(function (willDelete) {
                                            if (willDelete) {
                                                // Chuyển hướng URL với danh sách các ID sản phẩm

                                                window.location.href = "/SWP391_LapTop/rollbackCheckboxUser?ids=" + "&rollback=1" + "&page=" + page + "&num=" + num + "&key=" + key + "&entryperpage=" + entryperpage;
                                            }
                                        });
                                    } else {
                            ...
                            <script>
                                function updateProduct(productId, page, num, key, entryperpage)
                                {
                                    ...
                                    window.location.href = "/SWP391_LapTop/updateUser?id=" + productId + "&page=" + page + "&num=" + num + "&key=" + key + "&entryperpage=" + entryperpage + "&check=1";
                                }
