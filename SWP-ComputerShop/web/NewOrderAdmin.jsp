...
<html lang="en">
    ...
    <head>
        <title>Danh sách đơn hàng đang xử lý | Quản trị Admin</title>
        <meta charset="utf-8">
        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item active"><a href="ordermanager?order=1"><b>Danh sách đơn hàng đang xử lý</b></a></li>
                </ul>
                <div id="clock"></div>
            </div>
            <div class="row">
                        ...
                        <div class="tile-body">
                            <div class="row element-button">
                                <c:if test="${acc.getRoleID() == 1}">
                                    ...
                                    <div class="col-sm-2">
                                        <a class="btn btn-primary btn-sm mb-0" style="padding: 6px 10px" href="/SWP391_LapTop/ordermanager?order=2" title="Danh sách đơn hàng đang giao"><i class="fas fa-truck"></i>
                                            Danh sách đơn hàng đang giao</a>
                                    </div>
                                    <div class="col-sm-2">
                                        ...
                                        <c:if test="${list != null && !empty list}">
                                            <c:forEach items="${list}" var="l">
                                                <tr>
                                                    ...
                                                    <td class="text-center"><span class="btn btn-sm light btn-info">Chờ xử lý</span></td>
                                                    <td>
                                                        ...
                                                        <button class="btn btn-primary btn-sm check" type="button" title="Xác nhận" data-id ="${l.getOrderID()}"
                                                                data-status ="On delivery" data- data-path ="${pageContext.request.contextPath}" data-page ="${page}"
                                                                data-num ="${num}" data-key ="${key}" data-entryperpage ="${entryperpage}"
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <div class="dataTables_paginate paging_simple_numbers" id="sampleTable_paginate">
                                                <ul class="pagination1">
                                                    ...
                                                    <c:if test="${page != 1}">
                                                        <li class="paginate_button page-item previous disabled" id="sampleTable_previous">
                                                            <a href="ordermanager?page=${page-1}&key=${key}&entryperpage=${entryperpage}&num= ${num}&order=1" 
                                                    ...
                                                    <c:forEach begin="1" end="${num}" var="i">
                                                        ...
                                                        <c:if test="${i != page}">
                                                            <li class="paginate_button page-item active">
                                                                <a href="ordermanager?page=${i}&key=${key}&entryperpage=${entryperpage}&num= ${num}&order=1"
        ...
        <script>
                                                                    ...
                                                                    function getPa(orderID, path, status, page, num, key, entryperpage,user) {
                                                                        if (!status) {
                                                                            ...
                                                                            window.location.href = path + "/updateorder?orderID=" + orderID + "&status=" + status + "&page=" + page + "&num=" + num + "&key=" + key + "&entryperpage" + entryperpage + "&order=1";
                                                                    }
                                                                    function submit(page, num, key) {
                                                                        var entryperpage = document.getElementById('entryperpage');
                                                                        window.location.href = "/SWP391_LapTop/ordermanager?entryperpage=" + entryperpage.value + "&num=" + num + "&key=" + key + "&order=1";
                                                                        ;
                                                                    }
                                                                    jQuery(function () {
