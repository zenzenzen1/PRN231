            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="tile">
                        ...
                        <form method="post" action="updatestaff" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-xl-4">
                                ...
                                <div class="col-xl-8">
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <input name="id" type="hidden" value="${admin.getAdminID()}">
                                            <!-- Form Row-->
                                            ...
                                            <div class="row gx-3 mb-3">
                                                <div class="form-group  col-md-6">
                                                    <label for="exampleSelect1" class="small mb-1">Quyền</label>
                                                    <select class="form-control" name="role">
                                                        <option value="0" disabled>-- Chọn quyền --</option>
                                                        <c:forEach items="${list}" var="l">
                                                            <c:choose>
                                                                <c:when test="${l.getRoleID() == admin.getRole().getRoleID()}">
                                                                    <option value="${l.getRoleID()}" selected>${l.getRoleName()}</option>
                                                                </c:when>
                                                                <c:otherwise>
                                                ...
                                                <div class="col-md-6">
                                                    <label class="small mb-1" for="inputPhone">Tình trạng</label>
                                                    <select class="form-control" name="status">
                                                        <option value="0" disabled>-- Chọn tình trạng --</option>
                                                        <c:choose>
                                                            <c:when test="${admin.isStatus()}">
                                                                <option value="${admin.isStatus()}" selected>Xoá tài khoản</option>
                                                                <option value="${false}">Bình thường</option>
                                                            </c:when>
                                                            <c:otherwise>
                                                                <option value="${admin.isStatus()}" selected>Bình thường</option>
                                                                <option value="${true}">Xoá tài khoản</option>
                                                            </c:otherwise>
                                                        </c:choose>
                                                    </select>
                                                </div>
                                            ...
                                            <!-- Save changes button-->
                                            <button class="btn btn-save ml-0" type="submit">Lưu lại</button>
                                            <a class="btn btn-cancel ml-3" href="adminstaff?key=${key}&entryperpage=${entryperpage}&page=${page}">Hủy bỏ</a>
