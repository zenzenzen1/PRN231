        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb">
                    <li class="breadcrumb-item"><a href="list-blog-admin">Danh sách News</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <h3 class="tile-title">Sửa News</h3>
                        <div class="tile-body">
                            ...
                            <form class="row" action="edit-blog" method="post">    
                                <input class="form-control" name="id" type="hidden" value="${b.getNewsID()}" placeholder="">
                                <div class="form-group col-md-3">
                                    <label class="control-label">Title:</label>
                                    <input class="form-control" name="title" type="text" value="${b.getTitle()}" placeholder="">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label" >Video</label>
                                    <input class="form-control" type="text" value="${b.getVideo()}" name="video">
                                </div>
                                <div class="form-group  col-md-3">
                                    <label class="control-label" >Image</label>
                                    <input class="form-control" name="banner" value="${b.getImage()}" type="file">
                                </div>
                                <div class="form-group col-md-3 ">
                                    ...
                                    <select class="form-control" id="exampleSelect1" name="cateId">
                                        <c:forEach var="c" items="${bcl}">
                                            <option ${c.getNewsTypeID() == b.getNewsType() ? 'selected':''} value="${c.getNewsTypeID()}">${c.getNewsTypeName()}</option>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="content" id="default"  class="form-control"> ${b.getContent()}
                        </textarea>
             
                        
                                    <button type="submit" class="btn btn-save" >Sua</button>
