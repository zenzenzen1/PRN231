                        ...
                        <div class="tile-body">
                            <div class="row element-button">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <a class="btn btn-add btn-sm" href="/SWP391_LapTop/productAdmin" title="Thêm"><i class="fas fa-plus"></i>
                            ...
                            <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                ...
                                <button type="button" id="rollbackSelected" data-page ="${page}"
                                        data-num ="${num}" data-key ="${key}" data-entryperpage ="${entryperpage}"  class="btn btn-primary">Hoàn tác đã chọn</button>

                                <a id="rollbackAll" data-page ="${page}" data-size="${size}"
                                   data-num ="${num}" data-key ="${key}" data-entryperpage ="${entryperpage}" class="btn btn-primary">Hoàn tác tất cả</a>
                                ...
                                <table class="table table-hover table-bordered" id="sampleTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width : 9%">Tên sản phẩm</th>
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${data}" var="item">
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="imageProduct/20w0016eva-1.webp" alt="" width="100px;"></td>
                                                <td>${item.getQuantity()}</td>
                                                <td><span class="badge bg-danger">Đã xóa</span></td>
                                                <td>${item.getPrice()}</td>
                                                <td>${item.getCreatedAdmin()}</td>
                                                <td>${item.getCreatedDate()}</td>
                                                <td>${item.getModifiedAdmin()}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <button data-page ="${page}"
                                                            data-num ="${num}" data-key ="${key}" data-entryperpage ="${entryperpage}" class="btn btn-success undo" type="button" title="Hoàn tác"
                                                            onclick="myFunction(this)" data-id="${item.getProductID()}"><i class="fas fa-undo"></i> 
                                                    </button>
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <div class="dataTables_paginate paging_simple_numbers" id="sampleTable_paginate">
                                                <ul class="pagination1">
                                                    ...
                                                    <c:if test="${page != 1}">
                                                        <li class="paginate_button page-item previous disabled" id="sampleTable_previous">
                                                            <a href="/SWP391_LapTop/listDelete?page=${page-1}&key=${key}&entryperpage=${entryperpage}&num= ${num}" 
                                                    ...
                                                    <c:forEach begin="1" end="${num}" var="i">
                                                        ...
                                                        <c:if test="${i != page}">
                                                            <li class="paginate_button page-item active">
                                                                <a href="/SWP391_LapTop/listDelete?page=${i}&key=${key}&entryperpage=${entryperpage}&num= ${num}"
                            ...
                            <script>
                                jQuery(function () {
                                    jQuery(".undo").click(function () {
                                        ...
                                        swal({
                                            title: "Cảnh báo",
                                            text: "Bạn có chắc chắn là muốn hoàn tác sản phẩm này?",
                                            buttons: ["Hủy bỏ", "Đồng ý"],
                                        })
                                                .then((willUpdate) => {
                                                    if (willUpdate) {
                                                        // Chuyển hướng URL với ID sản phẩm 
                                                        window.location.href = "/SWP391_LapTop/rollback?id=" + productId + "&page=" + page + "&num=" + num + "&key=" + key + "&entryperpage=" + entryperpage;
                                                    }
                                                });
                                    });
                                });
                            ...
                            <script>
                                $(function () {
                                    $("#rollbackSelected").click(function () {
                                        ...
                                        if (selectedProducts.length > 0) {
                                            swal({
                                                title: "Cảnh báo",
                                                text: "Bạn có chắc chắn muốn hoàn tác các sản phẩm đã chọn?",
                                                buttons: ["Hủy bỏ", "Đồng ý"],
                                            }).then(function (willUpdate) {
                                                if (willUpdate) {
                                                    // Chuyển hướng URL với danh sách các ID sản phẩm
                                                    window.location.href = "/SWP391_LapTop/rollbackCheckbox?ids=" + selectedProducts.join(",") + "&rollback=0" + "&page=" + page + "&num=" + num + "&key=" + key + "&entryperpage=" + entryperpage;
                                                }
                                            });
                                        } else {
                                            swal("Cảnh báo", "Vui lòng chọn ít nhất một sản phẩm để hoàn tác.", "warning");
                                        }
                                    });
                                });
                            </script>
                            <script>
                                ...
                                document.getElementById("rollbackAll").addEventListener("click", function () {
                                    ...
                                    if (size > 0) {
                                        ...
                                        swal({
                                            title: "Cảnh báo",
                                            text: "Bạn có chắc chắn muốn hoàn tác tất cả sản phẩm ?",
                                            buttons: ["Hủy bỏ", "Đồng ý"],
                                        }).then(function (willDelete) {
                                            if (willDelete) {
                                                // Chuyển hướng URL với danh sách các ID sản phẩm

                                                window.location.href = "/SWP391_LapTop/rollbackCheckbox?ids=" + "&rollback=1" + "&page=" + page + "&num=" + num + "&key=" + key + "&entryperpage=" + entryperpage;
                                            }
                                        });
                                    } else {
                                        swal("Cảnh báo", "Không có sản phẩm để hoàn.", "warning");
                                    }
                                });
                                function errorRole() {
                                    swal({
                            ...
                            <script>
                                function updateProduct(productId, page, num, key, entryperpage)
                                {
                                    ...
                                    window.location.href = "/SWP391_LapTop/updateProduct?id=" + productId + "&page=" + page + "&num=" + num + "&key=" + key + "&entryperpage=" + entryperpage + "&check=1";
                                }
