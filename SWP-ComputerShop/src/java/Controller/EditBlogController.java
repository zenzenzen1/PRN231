...
public class EditBlogController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("b",new BlogDao().getBlogByID(id));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (a != null) {
            ...
            BlogDao bdao = new BlogDao();
            bdao.editBlog(Title, Content, NewsType, CreatedBy, ModifiedBy, Image, Video,Integer.parseInt(request.getParameter("id")));
