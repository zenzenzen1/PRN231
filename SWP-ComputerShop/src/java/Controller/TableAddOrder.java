 ...
 * @author wth0z
 */
public class TableAddOrder extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        int size = userDAO.getSizeOfList(request.getParameter("key"));
        ...
        List<User1> list = userDAO.getListByPage(start, numperpage, request.getParameter("key"));
        ...
        request.getRequestDispatcher("table-add-order.jsp").forward(request, response);
    } 
