...
public class AuthController : Controller
{
    ...
    {
        if(_context.Users.Any(x => x.Email == "admin@gmail.com"))
            return Ok();
        ...
        var createUser = new User()
        {
            ...
            EmailConfirmed = true,
            Password = BCrypt.Net.BCrypt.HashPassword("123123"), // length 6 -> 20
        ...
        var createUser3 = new User()
        {
            ...
            FullName = "",
            Status = (int)StatusUser.Normal,
            RoleId = (int)UserRoleEnum.UserVip
        };
        var userToken2 = new UserToken
        {
            ...
            Value = _jwt.WriteToken(
                createUser2.FullName,
                createUser2.Email,
                _extensionManga.CoverIntToEnum<UserRoleEnum>((int)createUser2.RoleId).ToString(),
                createUser2.Id.ToString(), "1111")
        };
        var userToken3 = new UserToken
        {
            Id = Guid.NewGuid(),
            UserId = createUser3.Id,
            Email = createUser3.Email,
            Expires = DateTime.UtcNow.AddDays(30),
            Value = _jwt.WriteToken(
                createUser3.FullName,
                createUser3.Email,
                _extensionManga.CoverIntToEnum<UserRoleEnum>((int)createUser3.RoleId).ToString(),
                createUser3.Id.ToString(), "1111")
        };
        ...
        _context.Users.AddRange(createUser, createUser2, createUser3);
        _context.UserTokens.AddRange(userToken, userToken2, userToken3);
