                    ...
                    if(externalEmailUser != null){
                        if(registerUser.Id == externalEmailUser.Id){
                            ...
                            if(resultLink.Succeeded){
                                ...
                                foreach (var error in resultLink.Errors)
                                {
                        ...
                        // ModelState.AddModelError(string.Empty, "we do not support ")
                    }
                }
                else{
                    if(externalEmailUser != null){
                        ModelState.AddModelError(string.Empty, "We do not support create account with external email");
                    }
                    else{
